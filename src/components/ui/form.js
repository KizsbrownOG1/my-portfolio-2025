...
var FormControl = React.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_slot_1.Slot, __assign({ ref: ref, id: formItemId, "aria-describedby": !error ? "".concat(formDescriptionId) : "".concat(formDescriptionId, " ").concat(formMessageId), "aria-invalid": !!error }, props)));
});
